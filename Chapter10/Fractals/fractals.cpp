...
Sequel Source::sourceToSequelTree()
{
	...
	coordsVal[0] = x1 + RATIO*cos((M_PI / 180.0)*ANGLE / 2.0)*(x1 - x0) - RATIO*sin((M_PI / 180.0)*ANGLE / 2.0)*(y1 - y0);
	coordsVal[1] = y1 + RATIO*cos((M_PI / 180.0)*ANGLE / 2.0)*(y1 - y0) + RATIO*sin((M_PI / 180.0)*ANGLE / 2.0)*(x1 - x0);
	coordsVal[2] = x1;
	coordsVal[3] = y1;
	coordsVal[4] = x1 + RATIO*cos((M_PI / 180.0)*ANGLE / 2.0)*(x1 - x0) + RATIO*sin((M_PI / 180.0)*ANGLE / 2.0)*(y1 - y0);
	coordsVal[5] = y1 + RATIO*cos((M_PI / 180.0)*ANGLE / 2.0)*(y1 - y0) - RATIO*sin((M_PI / 180.0)*ANGLE / 2.0)*(x1 - x0);
