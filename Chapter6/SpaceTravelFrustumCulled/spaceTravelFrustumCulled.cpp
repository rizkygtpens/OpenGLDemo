...
void drawScene(void)
{
		...
		// Draw all the asteroids in arrayAsteroids.
	{
		for (j = 0; j<COLUMNS; j++)
		 ...
		 // ( xVal - 10 * sin( (M_PI/180.0) * angle), 0, zVal - 10 * cos( (M_PI/180.0) * angle) ).
		asteroidsQuadtree.drawAsteroids(xVal - 10 * sin((M_PI / 180.0) * angle) - 7.072 * sin((M_PI / 180.0) * (45.0 + angle)),
			zVal - 10 * cos((M_PI / 180.0) * angle) - 7.072 * cos((M_PI / 180.0) * (45.0 + angle)),
			xVal - 10 * sin((M_PI / 180.0) * angle) - 353.6 * sin((M_PI / 180.0) * (45.0 + angle)),
			zVal - 10 * cos((M_PI / 180.0) * angle) - 353.6 * cos((M_PI / 180.0) * (45.0 + angle)),
			xVal - 10 * sin((M_PI / 180.0) * angle) + 353.6 * sin((M_PI / 180.0) * (45.0 - angle)),
			zVal - 10 * cos((M_PI / 180.0) * angle) - 353.6 * cos((M_PI / 180.0) * (45.0 - angle)),
			xVal - 10 * sin((M_PI / 180.0) * angle) + 7.072 * sin((M_PI / 180.0) * (45.0 - angle)),
			zVal - 10 * cos((M_PI / 180.0) * angle) - 7.072 * cos((M_PI / 180.0) * (45.0 - angle))
		);
	// End right viewport.
