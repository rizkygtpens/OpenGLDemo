...
Quaternion eulerAnglesToQuaternion(EulerAngles e)
{
	...
	q1 = new Quaternion(cos((M_PI / 180.0) * (alpha / 2.0)), sin((M_PI / 180.0) * (alpha / 2.0)), 0.0, 0.0);
	q2 = new Quaternion(cos((M_PI / 180.0) * (beta / 2.0)), 0.0, sin((M_PI / 180.0) * (beta / 2.0)), 0.0);
	q3 = new Quaternion(cos((M_PI / 180.0) * (gamma / 2.0)), 0.0, 0.0, sin((M_PI / 180.0) * (gamma / 2.0)));
