...
void drawScene(void)
{
	...
	// End first revolving ball.

	glPushMatrix();

	// Begin first revolving satellite.
	glRotatef(10 * latAngle, 0.0, 1.0, 0.0);
	glTranslatef(4.0, 0.0, 0.0);

	glColor3f(1.0, 1.0, 0.0);
	glutWireSphere(0.5, 5, 5);
	// End first revolving satellite.

	glPopMatrix();

	glPushMatrix();

	// Begin second revolving satellite.
	glRotatef(10 * latAngle, 1.0, 0.0, 0.0);
	glTranslatef(0.0, 4.0, 0.0);

	glColor3f(0.0, 1.0, 1.0);
	glutWireSphere(0.5, 5, 5);
	// End second revolving satellite.
	...
	glutWireSphere(2.0, 10, 10);
	// End second revolving ball.

	// Begin revolving satellite.
	glRotatef(10 * latAngle, 0.0, 1.0, 0.0);
	glTranslatef(4.0, 0.0, 0.0);

	glColor3f(1.0, 0.0, 1.0);
	glutWireSphere(0.5, 5, 5);
	// End revolving satellite.
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("experimentSceneGraph.cpp");
