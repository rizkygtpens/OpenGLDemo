...
void drawScene(void)
{
	...
	if (closestName == 1) glColor3fv(highlightColor);
	if (closestName != 1) glColor3f(1.0, 0.0, 0.0); glVertex3f(-3.0, -4.0, -5.3);
	if (closestName != 1) glColor3f(0.0, 1.0, 0.0); glVertex3f(-1.0, -4.0, -5.3);
	if (closestName != 1) glColor3f(0.0, 0.0, 1.0); glVertex3f(-3.0, 5.0, -5.3);
	glEnd();

	// Angled triangle.
	if (isSelecting) glLoadName(2);
	glBegin(GL_TRIANGLES);
	if (closestName == 2) glColor3fv(highlightColor);
	if (closestName != 2) glColor3f(0.0, 0.0, 0.0); glVertex3f(4.0, 4.0, -5.2);
	if (closestName != 2) glColor3f(1.0, 1.0, 1.0); glVertex3f(2.0, 4.0, -5.2);
	if (closestName != 2) glColor3f(0.0, 1.0, 1.0); glVertex3f(-5.0, -4.0, -5.2);
	glEnd();

	// Horizontal triangle.
	if (isSelecting) glLoadName(3);
	glBegin(GL_TRIANGLES);
	if (closestName == 3) glColor3fv(highlightColor);
	if (closestName != 3) glColor3f(0.0, 1.0, 1.0); glVertex3f(-4.0, 1.0, -5.1);
	if (closestName != 3) glColor3f(1.0, 1.0, 0.0); glVertex3f(-4.0, -1.0, -5.1);
	if (closestName != 3) glColor3f(1.0, 0.0, 1.0); glVertex3f(5.0, -1.0, -5.1);
	glEnd();
